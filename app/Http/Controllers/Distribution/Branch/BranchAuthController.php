...
namespace App\Http\Controllers\Distribution\Branch;
...
class BranchAuthController extends Controller
{
    ...
    public function dashboard(): View
    {
        ...
        return view('branch.dashboard', compact('branch', 'stats', 'recentOrders', 'branchDistributors'));
    }
    ...
    private function currentBranch(): Branch
    {
        ...
        return Branch::query()
            ->with(['supplier:id,owner_name,business_name,logo'])
            ->whereKey($account->branch_id)
            ->firstOrFail();
    }
}
