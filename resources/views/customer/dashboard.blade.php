...
<div class="container-fluid py-2">
    <div class="p-4 rounded-4 text-white mb-3" style="background: linear-gradient(135deg, #111827 0%, #374151 100%);">
        ...
        <p class="mb-0 text-white-50">متابعة طلبات وحساب {{ $typeLabel }}</p>

        <div class="d-flex flex-wrap align-items-center gap-3 mt-3">
            @if ($customer->logo_url)
            <div>
                <div class="small text-white-50 mb-1">لوجو {{ $typeLabel }}</div>
            ...
            <div class="flex-grow-1">
                <div class="small text-white-50 mb-1">صور {{ $typeLabel }}</div>
