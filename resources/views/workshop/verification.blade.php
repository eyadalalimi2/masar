...
<div class="d-flex justify-content-between align-items-center mb-3">
    <div>
        <h1 class="workshop-section-title mb-1">توثيق الحساب</h1>
        <p class="workshop-section-subtitle mb-0">إدارة وثائق التوثيق للورشة.</p>
    </div>
    <a href="{{ route('workshop.profile.index') }}" class="btn btn-outline-secondary btn-sm">رجوع للبروفايل</a>
</div>
...
<div class="mb-3 d-flex gap-2 align-items-center">
    ...
    @else
    <form action="{{ route('workshop.profile.request-verification') }}" method="POST" onsubmit="return confirm('إرسال طلب التوثيق للإدارة؟');">
        @csrf
        @method('PATCH')
...
<form method="POST" action="{{ route('workshop.profile.verification.update') }}" enctype="multipart/form-data" class="workshop-panel">
    @csrf
    @method('PUT')
    <div class="row g-2">
        <div class="col-md-4">
    ...
    <div class="text-end mt-3">
        <button type="submit" class="btn btn-primary btn-sm">حفظ وثائق التوثيق</button>
    </div>
</form>
@endsection