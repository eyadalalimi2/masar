                        ...
                        <div class="col-6">
                            <div class="dist-stat">
                                ...
                                <div class="fw-semibold fs-5">
                                    {{ number_format((float) $activity['performance_rate'], 1) }}%
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="dist-stat">
                                ...
                                <div class="fw-semibold fs-5">
                                    {{ number_format((float) $activity['on_time_deliveries_today']) }}
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="dist-stat">
                                ...
                                <div class="fw-semibold fs-5">
                                    {{ number_format((float) $activity['late_deliveries_today']) }}
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="dist-stat">
                                ...
                                <div class="fw-semibold fs-5">
                                    {{ number_format((float) $activity['on_time_rate_today'], 1) }}%
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <table class="table table-striped mb-0 align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('distributor.orders.show', ['order' => $order->id]) }}"
