...
<div class="container-fluid py-2">
    <div class="d-flex flex-wrap align-items-center justify-content-between mb-4 gap-2">
        <div>
            <h1 class="h4 mb-1">تفاصيل المنتج</h1>
            <p class="text-muted mb-0">عرض بيانات المنتج للمندوب</p>
        </div>
        <a href="{{ route('distributor.products.index') }}" class="btn btn-outline-dark">رجوع للمنتجات</a>
    </div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body p-4">
            ...
            <h2 class="h6 fw-bold mb-3">أسعار الجملة حسب الوحدة</h2>
