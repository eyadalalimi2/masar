...
<div class="container-fluid py-2">
    ...
    <div class="d-flex justify-content-end mb-2">
        <a href="{{ route('pos.profile.verification') }}" class="btn btn-outline-success btn-sm">طلب التوثيق</a>
    </div>
    ...
    <form method="POST" action="{{ route('pos.profile.update') }}" enctype="multipart/form-data"
        ...
        <div class="card-body row g-3">
            ...
            <div class="col-md-4">
                ...
                <input type="file" id="posOwnerImageInput" name="owner_image"
                    class="form-control {{ !empty($customer?->owner_image_url) ? 'd-none' : '' }}" accept="image/*">
                @if (!empty($customer?->owner_image_url))
                <label for="posOwnerImageInput" class="d-inline-block mt-2" style="cursor: pointer;">
            ...
            <div class="col-md-4">
                ...
                <input type="file" id="posLogoImageInput" name="logo"
                    class="form-control {{ !empty($customer?->logo_url) ? 'd-none' : '' }}" accept="image/*">
                @if (!empty($customer?->logo_url))
                <label for="posLogoImageInput" class="d-inline-block mt-2" style="cursor: pointer;">
