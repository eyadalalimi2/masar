<div class="col-md-4">
    ...
    <select name="type" class="form-select" required>
        <option value="workshop" @selected(old('type', $customer->type ?? '') === 'workshop')>ورشة</option>
        <option value="retail_store" @selected(old('type', $customer->type ?? '') === 'retail_store')>محل تجزئة</option>
    </select>
</div>
<div class="col-md-4">
