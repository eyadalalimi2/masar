...
@section('content')
    <h1 class="h4 fw-bold mb-4">إضافة فرع جديد</h1>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="password" name="branch_manager_password" class="form-control"
                        value="{{ old('branch_manager_password') }}">
                </div>

                <div class="col-md-6">
                    <label class="form-label">الموقع</label>
                    <input type="text" name="gps_location" class="form-control" value="{{ old('gps_location') }}"
                        placeholder="15.3694,44.1910">
                </div>
    ...
    <script>
        (() => {
            ...
            window.initAdminBranchCreateMapPicker = function() {
            ...
            script.src =
                `https://maps.googleapis.com/maps/api/js?key=${encodeURIComponent(mapsKey)}&libraries=places&callback=initAdminBranchCreateMapPicker&language=ar`;
            script.async = true;
            script.defer = true;
            script.onerror = () => {
