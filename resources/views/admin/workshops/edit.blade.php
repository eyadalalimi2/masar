...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('admin.workshops.index') }}" class="btn btn-outline-secondary">رجوع</a>
    </div>
    ...
    <form method="POST" action="{{ route('admin.workshops.update', $customer) }}" enctype="multipart/form-data"
    ...
    <form method="POST" action="{{ route('admin.workshops.updateWorkingHours', $customer) }}"
        class="card border-0 shadow-sm mt-3">
        @csrf
        @method('PUT')
        <div class="card-body">
            <h2 class="h6 fw-bold mb-1">تعديل أوقات الدوام</h2>
            <p class="text-muted small mb-3">يمكن للأدمن تعديل جدول عمل الورشة من هنا.</p>
