    ...
    <div class="container-fluid py-2">
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
            <div>
                ...
                <p class="text-muted mb-0">متابعة كل تنبيهات الفرع وتعليمها كمقروء.</p>
            </div>
            <div class="d-flex gap-2 align-items-center">
                <span class="badge text-bg-info">غير مقروء: {{ $unreadCount }}</span>
                <form method="POST" action="{{ route('branch.alerts.mark-all') }}">
                    @csrf
                    @method('PATCH')
        ...
        <form method="GET" action="{{ route('branch.alerts.index') }}" class="card border-0 shadow-sm mb-3">
