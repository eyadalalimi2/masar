...
@section('content')
<div class="table-wrap reveal rv1">
    <div class="card-body">
        <h1 class="h5 fw-bold mb-1">إدارة طرق الدفع</h1>
        <p class="text-muted mb-3">اختر الطرق التي يدعمها الفرع وأدخل تفاصيل الحساب لكل طريقة.</p>
        ...
        <form method="POST" action="{{ route('branch.payment-methods.update') }}">
            @csrf
            @method('PUT')
            @php
