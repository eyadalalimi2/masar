...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div class="d-flex gap-2">
        <a href="{{ route('branch.inventory.index') }}" class="btn btn-outline-primary">تسعير الفرع</a>
        <a href="{{ route('branch.products.index') }}" class="btn btn-outline-secondary">رجوع</a>
    </div>
</div>
