...
return [
    ...
    */
    ...
    'guards' => [
        ...
        'branch' => [
            'driver' => 'session',
            'provider' => 'branch_accounts',
        ],
        'distributor' => [
            'driver' => 'session',
            'provider' => 'distributor_accounts',
        ],
        'pos' => [
            'driver' => 'session',
            'provider' => 'pos_accounts',
        ],
        'workshop' => [
            'driver' => 'session',
            'provider' => 'workshop_accounts',
        ],
        'customer' => [
            'driver' => 'session',
            'provider' => 'customers',
    ...
    */
    ...
    'providers' => [
        ...
        'branch_accounts' => [
            'driver' => 'eloquent',
            'model' => BranchAccount::class,
        ],
        'distributor_accounts' => [
            'driver' => 'eloquent',
            'model' => DistributorAccount::class,
        ],
        'pos_accounts' => [
            'driver' => 'eloquent',
            'model' => Pos::class,
